...
class QuantitativeValue(ApiObject):
    ...
    value: Optional[Union[float, int]] = ApiField(default=None, description="A measured value")
    max_value: Optional[Union[float, int]] = ApiField(default=None, description="The maximum value of a range of measured values", alias="maxValue")
    min_value: Optional[Union[float, int]] = ApiField(default=None, description="The minimum value of a range of measured values", alias="minValue")
    ...
    quality_control: Optional[str] = ApiField(default=None, description="For values in observation records, the quality control flag from the MADIS system. The definitions of these flags can be found at https://madis.ncep.noaa.gov/madis_sfc_qc_notes.shtml ", alias="qualityControl")
