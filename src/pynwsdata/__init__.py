...
from pynwsdata.exceptions import OpenApiException
from pynwsdata.exceptions import ApiTypeError
from pynwsdata.exceptions import ApiValueError
from pynwsdata.exceptions import ApiKeyError
from pynwsdata.exceptions import ApiAttributeError
