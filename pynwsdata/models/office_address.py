...
class OfficeAddress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "streetAddress", "addressLocality", "addressRegion", "postalCode"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PostalAddress']):
            raise ValueError("must be one of enum values ('PostalAddress')")
        return value
