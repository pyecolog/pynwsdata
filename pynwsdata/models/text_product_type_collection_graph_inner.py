...
class TextProductTypeCollectionGraphInner(BaseModel):
    """
    TextProductTypeCollectionGraphInner
    """ # noqa: E501
    product_code: StrictStr = Field(alias="productCode")
    product_name: StrictStr = Field(alias="productName")
    __properties: ClassVar[List[str]] = ["productCode", "productName"]
